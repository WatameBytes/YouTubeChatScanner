...
from ComputeData.ComputeHelperFunctions import writeResultsToFile, convert_raw_time_data_to_dictionary
...
def dataProcessing():
    ...
    compute_filler_group(list_of_contents, selected_file_index, dict_with_raw_time_data, File)